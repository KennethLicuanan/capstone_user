...
<body>
    <nav class="navbar navbar-expand-lg custom-color">
      <div class="container-fluid">
        <a class="navbar-brand" href="dashboard.php"><img src="imgs/book.png" height="70" alt=""> Digi - Studies Administrator</a>
          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="courseDropdown">
                <li><a class="dropdown-item" href="./admin/IT.php">College of Computer Studies</a></li>
                <li><a class="dropdown-item" href="./admin/BA.php">Business Administration</a></li>
                <li><a class="dropdown-item" href="./admin/TEP.php">Teachers Education Program</a></li>
              </ul>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="./admin/add.php">Add Study</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./admin/manage.php">Manage Studies</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="./admin/user.php">User Log's</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="./admin/IT.php?type=BSIT" class="text-decoration-none">
                    <div class="analytics-card">
            ...
            <div class="col-md-6">
                <a href="./admin/TEP.php?type=TEP" class="text-decoration-none">
                    <div class="analytics-card">
            ...
            <div class="col-md-6">
                <a href="./admin/BA.php?type=BSBA" class="text-decoration-none">
                    <div class="analytics-card">
